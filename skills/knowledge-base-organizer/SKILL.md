...
description: Use when organizing reusable, non-sensitive, long-term personal or project knowledge into templates, prompts, skills, and checklists.
---
...
Use when organizing reusable, non-sensitive, long-term personal or project knowledge into templates, prompts, skills, and checklists.

## 使用方式

1. 先确认用户输入、资料范围、输出对象和禁止事项。
2. 优先遵循本仓库的长期协作偏好：中文、结构化、先结论、事实边界清楚、可直接复制使用。
3. 参考仓库中的 `templates/prompt-optimizer.md` 执行任务。
